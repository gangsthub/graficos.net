<template>
  <div class="relative">
    <button @click="isOpen = !isOpen" class="isolate z-1" aria-controls="top-menu">
    ...
    <transition appear>
      <section v-if="isOpen" :aria-expanded="isOpen" aria-live="polite" id="top-menu">
        <div class="card absolute top-full right-0 w-[300px]">
          <ul>
